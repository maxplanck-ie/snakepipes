...
* Deeptools coverage RPKM in mRNA-seq worflow now respects blacklist and ingoreForNorm arguments.
* In mRNA-seq workflow, deeptools qc will now also output DESeq2 size factor-normalized bigwig files.
