...
The differential binding module utilizes the R package ` CSAW <https://bioconductor.org/packages/release/bioc/html/csaw.html> ` to detect significantly different peaks between two conditions.
