...
snakePipes are flexible and powerful workflows built using `snakemake <snakemake.readthedocs.io>`__ that simplify the analysis of NGS data. <img style="float: right; width:200px;height:200px" src="https://raw.githubusercontent.com/maxplanck-ie/snakepipes/docs_vivek/snakePipes.png" >
