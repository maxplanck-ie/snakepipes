...
parser = argparse.ArgumentParser(
    "Summarize a table of reads/feature/cell/UMI into tables of reads/feature/cell, UMIs/feature/cell and Poisson corrected UMIs/feature/cell"
)
...
parser.add_argument(
    "ReadCounts",
    help="The output file name that will contain the number of reads per feature per cell",
)
parser.add_argument(
    "UMICounts",
    help="The output file name that will contain the uncorrected number of UMIs per feature per cell",
)
parser.add_argument(
    "CorrectedCounts",
    help="The output file name that will contain the corrected number of UMIs per feature per cell",
)
...
for line in f:
    ...
    # Add the read counts
    readCounts[cols[0]] = [
        x + int(y) for x, y in zip(readCounts[cols[0]], cols[2:], strict=False)
    ]
