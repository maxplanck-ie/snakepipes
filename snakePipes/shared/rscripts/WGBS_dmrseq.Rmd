...
Using a minimum methylation difference of `r minMethDiff` and FDR of `r FDR` there are a total of `r length(regions)` DMRs. The distribution of the methylation changes at these is shown below. Note that asymmetric changes in the distribution indicate global shifts in methylation between the groups.
