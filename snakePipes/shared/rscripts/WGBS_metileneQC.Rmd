...
# Annotated DMRs
################################
# Annotate with the nearest gene and its distance
...
Average methylation values for candidate DMRs in each of the groups are plotted below and stored in **`r outputDiffMethyl`**. In general, the starkness of the difference in the distributions should correlate to the number of candidate DMRs.
