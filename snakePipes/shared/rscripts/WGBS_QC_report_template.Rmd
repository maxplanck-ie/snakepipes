...
```{r , echo=FALSE}
QCdir<-params$QCdir
Mapdir=dir(gsub("QC_metrics","bams",QCdir),pattern="*.sorted.rmDupes.err.log$",full.names=TRUE,recursive=TRUE)
Mapdir.short<-gsub(".sorted.rmDupes.err.log","",basename(Mapdir))
