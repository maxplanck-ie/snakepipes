...
if(file.exists(file.path(snakemake@params[["outdir"]], "CSAW.UP.cov.heatmap.png"))){
    knitr::include_graphics(c(file.path(snakemake@params[["outdir"]], "CSAW.UP.cov.heatmap.png")))
}else{
    print("No UP regulated regions has been detected!")
}
if(file.exists(file.path(snakemake@params[["outdir"]], "CSAW.DOWN.cov.heatmap.png"))){
    knitr::include_graphics(c(file.path(snakemake@params[["outdir"]], "CSAW.DOWN.cov.heatmap.png")))
}else{
    print("No DOWN regulated regions has been detected!")
}
if(file.exists(file.path(snakemake@params[["outdir"]], "CSAW.MIXED.cov.heatmap.png"))){
    knitr::include_graphics(c(file.path(snakemake@params[["outdir"]], "CSAW.MIXED.cov.heatmap.png")))
}else{
    print("No MIXED regions has been detected!")
}
```
