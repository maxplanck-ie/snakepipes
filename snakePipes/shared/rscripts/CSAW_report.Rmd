...
if(!params$pipeline %in% "chip-seq"){message("ChIP signal enrichment over input is only available for ChIP-seq workflow!")}else{
    knitr::include_graphics(c(file.path(params$outdir,"CSAW.UP.log2r.heatmap.png"),file.path(params$outdir,"CSAW.DOWN.log2r.heatmap.png")))
    }
...
knitr::include_graphics(c(file.path(params$outdir,"CSAW.UP.cov.heatmap.png"),file.path(params$outdir,"CSAW.DOWN.cov.heatmap.png")))
```
