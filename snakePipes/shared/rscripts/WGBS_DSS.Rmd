...
infiles = snakemake@input[['bedGraphs']]
...
#infiles = sprintf("MethylDackel/%s.CpG.filt2.bed", ss$name)
...
bs = read.bismark(infiles, colData=ss)
sampleNames(bs) = as.character(ss$name)
dmlT = DMLtest(bs, group1=g1, group2=g2, smoothing=smoothing, smoothing.span=smoothingSpan)
