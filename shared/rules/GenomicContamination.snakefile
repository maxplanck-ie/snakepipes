...
rule GContamination_featurecount_all_report:
         ...
         run:
             ...
             shell('cat {input} | sort -k1,1V | cat <(echo "'+header+'") - | tee {output.report}')
