...
# print infile_AlignmentSummaryMetrics, os.path.isfile(infile_AlignmentSummaryMetrics)
# print infile_MarkDuplicates, os.path.isfile(infile_MarkDuplicates)
# print input_InsertSizeMetrics, os.path.isfile(input_InsertSizeMetrics)
# print infile_MACS2_xls, os.path.isfile(infile_MACS2_xls)
# print infile_MACS2_qc_txt, os.path.isfile(infile_MACS2_qc_txt)
...
try:
    ...
    ##print "dup_mapped_pairs:", dup_mapped_pairs

    fdup_mapped_pairs = 1.0 * dup_mapped_pairs / mapped_pairs
    ##print "fdup_mapped_pairs:", fdup_mapped_pairs

    dupfree_mapped_pairs = mapped_pairs - dup_mapped_pairs
    ##print "dupfree_mapped_pairs:", dupfree_mapped_pairs

    fdupfree_mapped_pairs = 1.0 * dupfree_mapped_pairs / read_pairs
    ##print "fdupfree_mapped_pairs:", fdupfree_mapped_pairs
except:
