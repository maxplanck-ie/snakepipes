...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 184 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 192 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 239 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1077 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1121 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 973 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1707 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 746 ]; then exit 1 ; fi
# allelic
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1175 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1207 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1211 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1144 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1216 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1172 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1585 ]; then exit 1 ; fi
#allelic
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 2328 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1271 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 1137 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 583 ]; then exit 1 ; fi
