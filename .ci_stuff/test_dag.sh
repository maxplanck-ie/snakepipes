...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 230 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 238 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 285 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 547 ]; then exit 1 ; fi
...
if [ ${PIPESTATUS[0]} -ne 0 ] || [ $WC -ne 475 ]; then exit 1 ; fi
